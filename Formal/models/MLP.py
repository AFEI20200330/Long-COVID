...
models_params = {
    'MLPClassifier': {
        ...
        'params': {
            'hidden_layer_sizes': [(50,),(100,), (50, 50),(100,50),(100, 100),(50, 35, 25), (70, 50, 35),(100,75,50)],
...
for name, mp in models_params.items():
    ...
    # SHAP 值的计算
    explainer = shap.KernelExplainer(best_model.predict,shap.sample(X_train,50,random_state=42))
